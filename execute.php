...
elseif($text=="presentati")
{
	...
	$response = or "La mutazione è la chiave della nostra evoluzione, ci ha consentito di evolverci da organismi monocellulari a specie dominante sul pianeta. Questo processo è lento e normalmente richiede migliaia e migliaia di anni, ma ogni centinaio di millenni l’evoluzione fa un balzo in avanti"
	...
	$response = or "Credo che la concentrazione si trovi ad un certo punto tra la rabbia e la serenità."
	$response = or "Per l’uomo di Neandertal il suo cugino mutante, l’homo sapiens, era un’aberrazione. La coabitazione pacifica, se mai ci fu, ebbe vita breve: i ritrovamenti indicano senza eccezione che all’arrivo della specie umana mutata in qualsiasi regione è seguita l’immediata estinzione del parente meno evoluto."
	$response = or "In te c’è molto più di quanto sai, non solo rabbia e dolore, c’è anche del bene, L’ho sentito! E quando saprai dominare tutto questo avrai un potere che nessuno potrà eguagliare, nemmeno io!"
	$response = or "Ho sempre pensato che non potevo essere l’unico al mondo! L’unico ad essere... diverso! Ed infatti eccoti qui!";
}
